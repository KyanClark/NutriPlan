...
import 'package:nutriplan/user/screens/recipes/recipe_steps_summary_page.dart';
...
class _MacroChip extends StatelessWidget {
  ...
  String? _getIconPath(String label) {
    switch (label.toLowerCase()) {
      case 'carbs':
        return 'assets/meal-tracker-icons/carbs_icon.png';
      case 'protein':
        return 'assets/meal-tracker-icons/protein_icon.png';
      case 'fat':
        return 'assets/meal-tracker-icons/fats_icon.png';
      case 'fiber':
        return 'assets/meal-tracker-icons/fiber_icon.png';
      case 'sugar':
        return 'assets/meal-tracker-icons/sugar-cube.png';
      case 'sodium':
        return 'assets/meal-tracker-icons/sodium.png';
      case 'cholesterol':
        return 'assets/meal-tracker-icons/cholesterol.png';
      default:
        return null;
    }
  }
  ...
  Future<void> _addToMealPlan(TimeOfDay time) async {
    try {
      ...
      if (time.hour >= 4 && time.hour < 12) {
        mealType = 'breakfast';    // 4 AM - 12 PM (more flexible)
      } else if (time.hour >= 12 && time.hour < 17) {
        mealType = 'lunch';        // 12 PM - 5 PM
