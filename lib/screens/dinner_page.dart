            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'End your day with delicious and wholesome dinner options',
                    style: TextStyle(
        ...
        child: FloatingActionButton.extended(
          onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Add dinner meal functionality coming soon!'),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Tap the + button to add your first dinner meal',
            style: TextStyle(
              fontSize: ResponsiveDesign.responsiveFontSize(context, 14),
