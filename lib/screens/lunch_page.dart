            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Fuel your afternoon with balanced and satisfying dishes',
                    style: TextStyle(
        ...
        child: FloatingActionButton.extended(
          onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Add lunch meal functionality coming soon!'),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Tap the + button to add your first lunch meal',
            style: TextStyle(
              fontSize: ResponsiveDesign.responsiveFontSize(context, 14),
