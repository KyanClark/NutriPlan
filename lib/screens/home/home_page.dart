                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('${recipe.calories} kcal', style: const TextStyle(color: Colors.white70, fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
                  ],
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text('${recipe.calories} kcal', style: const TextStyle(color: Colors.white70)),
                        ],
                      ),
                    ),
                  ],
